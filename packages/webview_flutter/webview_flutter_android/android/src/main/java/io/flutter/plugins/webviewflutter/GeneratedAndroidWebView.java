...
public class GeneratedAndroidWebView {
  ...
  public static class WebResourceRequestData {
    ...
    public Boolean getIsForMainFrame() { return isForMainFrame; }
    public void setIsForMainFrame(Boolean setterArg) { this.isForMainFrame = setterArg; }

    private Boolean isRedirect;
    public Boolean getIsRedirect() { return isRedirect; }
    public void setIsRedirect(Boolean setterArg) { this.isRedirect = setterArg; }

    private Boolean hasGesture;
    public Boolean getHasGesture() { return hasGesture; }
    public void setHasGesture(Boolean setterArg) { this.hasGesture = setterArg; }
    ...
    public void setRequestHeaders(Map<String, String> setterArg) { this.requestHeaders = setterArg; }
  ...
  public interface WebViewHostApi {
    ...
    void loadDataWithBaseUrl(Long instanceId, String baseUrl, String data, String mimeType, String encoding, String historyUrl);
    ...
    static void setup(BinaryMessenger binaryMessenger, WebViewHostApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebViewHostApi.dispose", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.loadDataWithBaseUrl(instanceIdArg.longValue(), baseUrlArg, dataArg, mimeTypeArg, encodingArg, historyUrlArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.evaluateJavascript(instanceIdArg.longValue(), javascriptStringArg, resultCallback);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.setWebViewClient(instanceIdArg.longValue(), webViewClientInstanceIdArg.longValue());
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.addJavaScriptChannel(instanceIdArg.longValue(), javaScriptChannelInstanceIdArg.longValue());
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.removeJavaScriptChannel(instanceIdArg.longValue(), javaScriptChannelInstanceIdArg.longValue());
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.setWebChromeClient(instanceIdArg.longValue(), clientInstanceIdArg.longValue());
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
  ...
  public static class JavaScriptChannelFlutterApi {
    ...
    public void dispose(Long instanceIdArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.JavaScriptChannelFlutterApi.dispose", getCodec());
      ...
      } else 
{
  ...
  public static class WebViewClientFlutterApi {
    ...
    public void dispose(Long instanceIdArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebViewClientFlutterApi.dispose", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(instanceIdArg)), channelReply -> {
        callback.reply(null);
      });
    }
    public void onPageStarted(Long instanceIdArg, Long webViewInstanceIdArg, String urlArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
    ...
    public void onPageFinished(Long instanceIdArg, Long webViewInstanceIdArg, String urlArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
    ...
    public void onReceivedRequestError(Long instanceIdArg, Long webViewInstanceIdArg, WebResourceRequestData requestArg, WebResourceErrorData errorArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
    ...
    public void onReceivedError(Long instanceIdArg, Long webViewInstanceIdArg, Long errorCodeArg, String descriptionArg, String failingUrlArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
  ...
  public static class DownloadListenerFlutterApi {
    ...
    public void dispose(Long instanceIdArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.DownloadListenerFlutterApi.dispose", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(instanceIdArg)), channelReply -> {
        callback.reply(null);
      });
    }
    public void onDownloadStart(Long instanceIdArg, String urlArg, String userAgentArg, String contentDispositionArg, String mimetypeArg, Long contentLengthArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
  ...
  public static class WebChromeClientFlutterApi {
    ...
    public void dispose(Long instanceIdArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebChromeClientFlutterApi.dispose", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(instanceIdArg)), channelReply -> {
        callback.reply(null);
      });
    }
    public void onProgressChanged(Long instanceIdArg, Long webViewInstanceIdArg, Long progressArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
